<template>
  <div :class="$style.component">
    ...
    <input
      v-model="_1nce_username_input"
      :class="$style._1nce_username_input"
      :disabled=!valid1nceApiToken
      placeholder="1nce username">
    <input
      v-model="_1nce_password_input"
      :class="$style._1nce_password_input"
      :disabled=!valid1nceApiToken
...
_1nce_url_base = 'https://api.1nce.com/management-api/';
...
_1nce_url_base_v = _1nce_url_base + 'v1/';
