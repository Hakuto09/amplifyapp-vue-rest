<template>
  <div :class="$style.component">
    ...
    <br><br>
    <h2>1NCE Latest Devices Positions 情報</h2>
    <h3>(接続先の基地局位置情報)</h3>
    ...
    <h3>SIM残量 (MB): {{ d_1nce_sim_data_quata_volume }}</h3>
...
//          console.log(fileName, funcName[0], funcName[1], " Before set this.d_1nce_sim_data_quata_all_json:");
        ...
        .catch(error => {
          ...
          this.message_1nce_sim_quota_result = "1NCE SIMのデータ割当情報の取得に失敗しました。";
        });
      }
      else {
        this.valid1nceApiToken = false;
...
//            console.log(fileName, funcName[0], funcName[1], " Before set map position");
        ...
        .catch(error => {
          ...
          this.valid1nceApiToken = false;
          this.message_1nce_token_result = "1NCE APIアクセスに失敗しました。トークンを更新してください。";
          this.message_1nce_locate_result = "1NCE SIM デバイスの位置情報の取得に失敗しました。";
        });
