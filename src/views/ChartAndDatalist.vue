<template>
  <div :class="$style.component">
    ...
    <div>
      ...
      <!-- Line width="1280" height="720" :data="data" :options="options" @error="handleChartError" / -->
...
//              data: chartData,
      ...
      mounted() {
        const funcName = [":components:", "mounted:"];
        console.log(fileName, funcName[0], funcName[1], "In.", " this ", this);
        console.log(fileName, funcName[0], funcName[1], "Before this.renderChartWithCatch()");
        this.renderChartWithCatch();
      },
      watch: {
        data() {
          const funcName = [":components:", "watch:data():"];
          console.log(fileName, funcName[0], funcName[1], "In.", " this ", this);
          console.log(fileName, funcName[0], funcName[1], "Before this.renderChartWithCatch()");
          this.renderChartWithCatch();
        },
        options() {
          const funcName = [":components:", "watch:options():"];
          console.log(fileName, funcName[0], funcName[1], "In.", " this ", this);
          console.log(fileName, funcName[0], funcName[1], "Before this.renderChartWithCatch()");
          this.renderChartWithCatch();
        }
