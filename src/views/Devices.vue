...
async function getDevices(/*userId*/) {
  console.log("Devices.vue:", " getDevices(): In.");
...
//   const { username, userId, signInDetails } = await getCurrentUser();
//    console.log("Devices.vue:", "data-function():", "After getCurrentUser():", " username ", username, " userId ", userId, " signInDetails ", signInDetails);     

//    if (userId) {
      const ret = getDevices(/*userId*/);
...
//    let account_id = ref('')
//    console.log("Devices.vue:", "data-function():", " account_id ", account_id);
//    console.log("Devices.vue:", "data-function():", " this.account_id ", this.account_id);
